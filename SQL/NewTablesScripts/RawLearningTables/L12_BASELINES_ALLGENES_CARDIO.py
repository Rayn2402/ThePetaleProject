...
"L1_BASELINES_ALLGENES_CARDIOMETABOLIC_RAW" table.
"""
...
data_cleaner = DataCleaner(join(CLEANING_RECORDS, "BASELINES_ALLGENES_CARDIO"), column_thresh=COLUMN_REMOVAL_THRESHOLD,
