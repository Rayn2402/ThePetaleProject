...
df_cardio_3 = data_manager.get_table("Cardio_3_Questionnaire d'Activité Physique (QAP)", columns=Cardio_3_vars.keys())
df_cardio_4 = data_manager.get_table("Cardio_4_Test de Marche de 6 Minutes (TDM6)", columns=Cardio_4_vars.keys())
...
df_cardio_3 = df_cardio_3[df_cardio_3["Tag"] == "Phase 1"]
df_cardio_4 = df_cardio_4[df_cardio_4["Tag"] == "Phase 1"]
...
# We create the table
data_manager.create_and_fill_table(complete_df, "Learning_0_6MWT_and_Generals (WarmUp)", types=vars, primary_key=pkey)
