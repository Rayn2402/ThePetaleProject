...
if __name__ == '__main__':
    ...
    from src.data.processing.sampling import extract_masks, GeneChoice, get_obesity_data
    ...
    # Extraction of data
    df, target, cont_cols, cat_cols = get_obesity_data(PetaleDataManager(), genes=gene_choice)
