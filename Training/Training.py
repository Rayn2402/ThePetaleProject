...
class Trainer():
    ...
    def fit(self, train_set, val_set, batch_size, lr, epochs, optimizer_name="Adam", early_stopping_activated=True,
    ...
    def cross_valid(self, datasets, batch_size, optimizer_name, lr, epochs, metric, k=5, early_stopping_activated=True,
                    patience=5):
        """
