...
This file is used to store the procedure to test Neural Networks experiments on the learning_01 dataset.
"""
import argparse
...
if __name__ == '__main__':
    ...
    for c in complications:
        ...
        for seed in seeds:
            ...
            evaluation_name = f"l1_neural_network_k{k}_l{l}_n{n_trials}_s{seed}_c{c}_g{genes}{b}"
